import {Container, FileInfo} from '.';
...
export default class extends Container {
	...
	/**
	 * Constructs new AzureContainer object.
	 * 
	...
	/**
	 * @async
	 * @return {string[]} List of blobs in the container.
	 */
	listFiles() {
		var self = this;
	 ...
	 * @param  {*}   continuationToken Continuation token from blob service. Null if it is first call.
	 */
	_listFiles(done, reject, continuationToken) {
		var self = this;
		var blobs = [];
		if (continuationToken)
			console.log('Continuation Token!');
